...
Both directional trades. How to make money with bi-directional trades?

all I want is to find a way to generate the fair data representations.

1. The sensitive attributes must be factored out from the non-sensitive attributes.
2. But, I don't know what the sensitive attributes are.
3. need a way to find out the most under-represented features in the data.
4. something needs to be done in the latent space.
5. rank/rate an example based on the representation of its latent features in the data.
6. even if we have access to the sensitive attributes, then what?
7. disentanglement?
8. latent variables models. how to use the latent distribution for my purposes.
